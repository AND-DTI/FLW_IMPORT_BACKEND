...
public class SwaggerConfig {
  ...
  public Docket docket(){
      return new Docket(DocumentationType.SWAGGER_2)
          ...
          .apis(RequestHandlerSelectors.basePackage("com.flw_import.api.controller"))
      ...
      private ApiInfo metaData() {
          return new ApiInfoBuilder()
                  .title("Follow Import - REST API")
                  .description("Spring Boot REST API - Follow Import Proccess")
                  .version("1.0.0")
                  .license("Apache License Version 2.0")
                  .licenseUrl("https://www.apache.org/licenses/LICENSE-2.0")
                  .contact(new Contact("Anderson (DTI)", "https://intra-web-hda.com", "contato@honda.com.br"))
                  .build();
      }
